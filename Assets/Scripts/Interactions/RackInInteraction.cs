...
public class RackInInteraction : BaseInteraction
{
    ...
    public override IEnumerator Process()
    {
        ...
        if (keyAnimTransform != null && handleAnimTransform != null)
        {
            ...
            handleRotateAnim = handleAnimTransform.DOLocalRotate(new Vector3(0, 90, -180f), 1f).SetLoops(-1, LoopType.Incremental).SetEase(Ease.Linear);
            GuidingArrow.Instance.SetTarget(handleInstance.transform);
        ...
        // yield return new WaitUntil(() => handleKnob.selectEntered != null);
